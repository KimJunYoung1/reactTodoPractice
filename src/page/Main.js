...
import { LogoutButton, TodoAddButton } from '../component/BaseButton';
...
export const Main = (props) => {
    ...
    const TodoListAdd = (e) => {
        const addTodo = [ ...TodoList, {id: TodoList.length + 1, contents: TodoContents, time: HandleDateAndTime(), completed: false}];
        // 데이터 추가해주는 부분, length + 1 부분 수정하기 삭제하고 다시 만들때 id값이 고유값이 안됨
        console.log('잘 들어오니', addTodo);
